                                                    ...
                                                    <template v-slot:content>
                                                        ...
                                                        <div class="row" v-if="sendEmailLink">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" v-model="copyMeLink"
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" v-model="linkEmail"
                                                                            type="checkbox" id="check-email-link">
                                                                        <label class="form-check-label"
                                                    ...
                                                    <template v-slot:content>
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" v-model="sendEmail"
