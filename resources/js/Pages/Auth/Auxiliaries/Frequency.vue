                                        ...
                                        <tbody>
                                            <tr v-for="(frequency, index) in frequencies"
                                                ...
                                                <td>
                                                    ...
                                                    <button v-if="!frequency.active" class="btn btn-sm btn-success btn-icon-split mr-2"
                                                        v-on:click="activate(frequency.id)">
                                                        <span class="icon text-white-50">
                                                    ...
                                                    <button v-if="frequency.active" class="btn btn-sm btn-warning btn-icon-split mr-2"
                                                        v-on:click="deactivate(frequency.id)">
                                                        <span class="icon text-white-50">
