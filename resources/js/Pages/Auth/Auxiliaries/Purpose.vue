...
const deletePurpose = (id) => {
    isLoader.value = true;
    formDelete.id = id;
    formDelete.delete(route('purpose-delete'), {
        onFinish: () => {
...
const activate = (id) => {
    isLoader.value = true;
    form.put(route('purposes-activate', id), {
        onFinish: () => {
            isLoader.value = false;
        },
    });
...
const deactivate = (id) => {
    isLoader.value = true;
    form.put(route('purposes-deactivate', id), {
        onFinish: () => {
            isLoader.value = false;
        },
    });
