...
const deleteService = (id) => {
    isLoader.value = true;
    formDelete.id = id;
    formDelete.delete(route('service-add-delete'), {
        onFinish: () => {
...
const submit = () => {
    form.post(route('service-add-save'), {
        onSuccess: () => {
            form.reset();
            inEdition.value = 0;
        },
...
const activate = (id) => {
    isLoader.value = true;
    form.put(route('service_adds-activate', id), {
        onFinish: () => {
            isLoader.value = false;
        },
    });
...
const deactivate = (id) => {
    isLoader.value = true;
    form.put(route('service_adds-deactivate', id), {
        onFinish: () => {
            isLoader.value = false;
        },
    });
