...
class EventApiController extends Controller
{
    ...
    public function getEditData(Request $request, $id = 0)
    {
        ...
        $payload = [
            ...
            'customerRequesters' => \App\Models\CustomerRequester::active()->get(),
            'customerSectors' => \App\Models\CustomerSector::active()->get(),
            'customerCostCenters' => \App\Models\CustomerCostCenter::active()->get(),
