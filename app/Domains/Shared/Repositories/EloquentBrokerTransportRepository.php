...
class EloquentBrokerTransportRepository extends EloquentBaseRepository implements BrokerTransportRepositoryInterface
{
    public function __construct(BrokerTransport $model)
    {
