...
class CreateEventAddTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('event_add', function (Blueprint $table) {
            $table->id();

            $table->bigInteger('add_id')->unsigned()->index();
            ...
            $table->foreign('add_id')->references('id')->on('provider');
