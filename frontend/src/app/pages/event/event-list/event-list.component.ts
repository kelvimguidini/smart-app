...
export class EventListComponent implements OnInit, AfterViewInit {
  ...
  fieldLabels: { [key: string]: string } = {
    ...
    pax_economica: 'Pax Econômica',
    total_pax: 'Total Pax',
    prazo_cia: 'Prazo da Cia',
    inc_taxa_embarque: 'Taxa de Embarque',
    inc_servico_bordo: 'Serviço de Bordo',
    inc_porao: 'Porão',
    inc_bagagem_bordo: 'Bagagem a bordo',
    inc_sala_vip: 'Sala VIP',
    inc_fbo_origem: 'FBO Origem',
    inc_fbo_destino: 'FBO Destino',
    inc_alteracao_nomes: 'Alteração de Nomes',
    taxa_embarque_unit: 'Taxa de Embarque Unitária',
    total_net_sem_4bts: 'Custo Net',
    markup: 'Mark Up',
    flight_number: 'Número do Voo',
    origin: 'Origem',
    destination: 'Destino',
    departure_time: 'Horário Saída',
    arrival_time: 'Horário Chegada',
    departure_date: 'Data Saída',
